    ...
    <> 
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50 z-0  " />
        <div className="flex flex-col items-center justify-center top-12 relative z-10  ">
          <div className={subtitle({ class: " text-xs  mb-0 md:mb-10 max-w-xl text-center justify-center dark:text-white text-black" })}>
            The road to freedom starts here
          </div>
        
          <TypewriterEffect words={words} />
          <div className={subtitle({ class: "mt-0 md:mt-10 max-w-xl text-center justify-center  text-black dark:text-white " })}>
          ...
          <div className="flex flex-col md:flex-row space-y-4  md:space-y-0 space-x-0 md:space-x-4 mt-0 md:mt-10">
            ...
            <Button variant="bordered" className="dark:text-white hidden md:block text-black ">
              Explore Now
            </Button>
          </div>
        </div>
